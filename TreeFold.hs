...
treeFoldPost f b (Node v l r) = f (treeFoldPost f b l) (treeFoldPost f b r) v
...
treeFoldPre f b (Node v l r) = f v (treeFoldPre f b l) (treeFoldPre f b r)
...
treeFoldIn f b (Node v l r) = f (treeFoldIn f b l) v (treeFoldIn f b r) 